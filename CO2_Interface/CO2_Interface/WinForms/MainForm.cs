...
namespace CO2_Interface
{
    public partial class MainForm : Form
    {
        ...
        /************* CODE EXAMEN: DEBUT *************/
        internal Controls.ErrorsTable ErrorsTablePage;
        /************* CODE EXAMEN: FIN **************/
        ...
        public MainForm()
        {
            ...
            /************* CODE EXAMEN: DEBUT *************/
            this.ErrorsTablePage = new Controls.ErrorsTable();
            /************* CODE EXAMEN: FIN **************/
        ...
        private static void TableCreation()
        {
            ...
            Data.Tables.DataErrors.Columns.Add(Data.Tables.Columns4.Ref);
            Data.Tables.DataErrors.Columns.Add(Data.Tables.Columns4.Type);
            Data.Tables.DataErrors.Columns.Add(Data.Tables.Columns4.Date);
            Data.Tables.DataErrors.Columns.Add(Data.Tables.Columns4.Description);
        ...
        private void OpenPort()
        {
            ...
            catch (Exception ex)
            {
                ...
                Data.Errors err = new Data.Errors(1, ex.Message);
                ...
                foreach (Data.FromSensor.Measure item in Data.Collections.ObjectList)
                {
                    if (item.ID == (byte)MeasureTablePage.idMenu.SelectedItem)
                    {
                        ...
                        if (item.ID != 0)
                        {
                            ...
                            if (highLimit < lowLimit || (highLimit == 0 && lowLimit == 0))
                            {
                                correctInput = false;
                                MessageBox.Show("Erreur ! Veuillez insérer vos valeurs du plus grand au plus petit");
                                /************* CODE EXAMEN: DEBUT *************/

                                Data.Errors err = new Data.Errors(5, "#Code 42");
                                SerialDataHandler.Reception.LoadErrors(err, Data.Tables.DataErrors);
        ...
        private void TimerTreatement_Tick(object sender, EventArgs e)
        {
            ...
            SerialDataHandler.Reception.LoadErrorsToDataTable(Data.Tables.DataErrors, ErrorsTablePage.ErrorsGrid, ErrorsTablePage);
        ...
        {
            MyContainer.Controls.Clear();//Permet d'ouvrir la page des erreurs
            MyContainer.Controls.Add(ErrorsTablePage);
        }
        ...
        private void Form1_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            if (MessageBox.Show("Vous êtes sur le point de fermer l'application \n Êtes-vous sûr de quitter ?", "My Application",
        ...
        public void saveToErrorsLog()
        {
            var fileContent = string.Empty;


            string filePath = Directory.GetCurrentDirectory();
            filePath += "\\ErrorLogs.csv";

            if (!File.Exists(filePath))
            {

                fileContent += "MeteoStation_Errors_file\r\n";

                fileContent += "Ref;";
                fileContent += "Type;";
                fileContent += "Date;";
                fileContent += "Descritpion;";
                ...
                foreach (Data.Errors err in Data.Collections.ErrorList)
                {
                    ...
                    fileContent += err.Ref + ";";
                    fileContent += err.Type + ";";
                    fileContent += err.Date + ";";
                    fileContent += err.Description + ";";
                    fileContent += "\r\n";
                }
